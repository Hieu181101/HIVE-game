...
public class GrasshopperPiece extends GamePiece {
    public GrasshopperPiece(Player owner, Game game) {
        this.owner = owner;
        this.flyweight = PieceFlyweightFactory.getInstance().get(PieceType.Grasshopper);
        this.game = game;
    }
