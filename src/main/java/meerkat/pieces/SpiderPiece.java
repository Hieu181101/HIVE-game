...
public class SpiderPiece extends GamePiece {
    public SpiderPiece(Player owner, Game game) {
        this.owner = owner;
        this.flyweight = PieceFlyweightFactory.getInstance().get(PieceType.Spider);
        this.game = game;
    }
